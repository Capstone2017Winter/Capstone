...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../webServerFlashFinal.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x19090d0
SOPC_SYSID_FLAG += --sidp=0x19090d0
ELF_PATCH_FLAG  += --sidp 0x19090d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1365631171
SOPC_SYSID_FLAG += --timestamp=1365631171
ELF_PATCH_FLAG  += --timestamp 1365631171
