...
1.1) `make test` if you want to run the tests
2.) `sudo make install` to install the library
3.) `sudo ldconfig` to update the linker so it can find the newly built library
